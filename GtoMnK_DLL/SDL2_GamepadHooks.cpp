...
Uint8 SDLCALL Hook_SDL_GameControllerGetButtonMask(SDL_GameController* gamecontroller, SDL_GameControllerButton button) {
    ...
    case SDL_CONTROLLER_BUTTON_GUIDE: customID = CUSTOM_ID_GUIDE; break;
    case SDL_CONTROLLER_BUTTON_MISC1: customID = CUSTOM_ID_MISC1; break;
    case SDL_CONTROLLER_BUTTON_PADDLE1: customID = CUSTOM_ID_PADDLE1; break;
    case SDL_CONTROLLER_BUTTON_PADDLE2: customID = CUSTOM_ID_PADDLE2; break;
    case SDL_CONTROLLER_BUTTON_PADDLE3: customID = CUSTOM_ID_PADDLE3; break;
    case SDL_CONTROLLER_BUTTON_PADDLE4: customID = CUSTOM_ID_PADDLE4; break;
