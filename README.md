...
GtoMnK reads settings from the [`GtoMnK.ini`](https://github.com/SAM1430B/GtoMnK/blob/master/GtoMnK_DLL/Documents/GtoMnK.ini) file for configuration and maps controller buttons using [key codes](https://github.com/SAM1430B/GtoMnK/blob/master/GtoMnK_DLL/Documents/GtoMnK_Keys.txt).
